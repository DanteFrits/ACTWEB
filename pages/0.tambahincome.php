...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
            ...
            <div class="ms-sm-auto ml-10">
              <form method="post">
                ...
                <div class="form-group">
                  ...
                  <select name="ic_talent" class="form-control">
                  <option value="">-Pilih Talent-</option>

                  <?php
                  $query = mysqli_query($koneksi, "SELECT * FROM talent_db ORDER BY tl_nama");
                  while ($data = mysqli_fetch_array($query)) {
                  echo '<option value="' . $data['tl_nama'] . '">' . $data['tl_nama'] . '</option>';
                  }
                  ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select name="ic_staff" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="ic_trakteer">
                </div>
                <div class="form-group">
                  <label for="Input Saweria">Saldo Saweria</label>
                  <input type="text" class="form-control" name="ic_saweria">
                </div>
                <div class="form-group">
                  <label for="Input Socialbuzz">Saldo SocialBuzz</label>
                  <input type="text" class="form-control" name="ic_socialbuzz">
                </div>
                <div class="form-group">
                  <label for="Input Youtube Adsense">Youtube Adsense</label>
                  <input type="text" class="form-control" name="ic_yt">
                </div>
                <div class="form-group">
                  <label for="Input Income Tiktok">Tiktok</label>
                  <input type="text" class="form-control" name="ic_tiktok">
                </div>
    ...
    if(isset($_POST['proses'])){
        mysqli_query($koneksi, "insert into income_db set
        ic_date         = '$_POST[ic_date]',
        ic_talent       = '$_POST[ic_talent]',
        ic_staff        = '$_POST[ic_staff]',
        ...
        echo "Penambahan Income Berhasil";
    }
    ?>
  </div>
</main>
