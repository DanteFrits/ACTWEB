...
INSERT INTO `income_db` (`ic_id`, `ic_date`, `ic_talent`, `ic_staff`, `ic_trakteer`, `ic_saweria`, `ic_socialbuzz`, `ic_yt`, `ic_tiktok`) VALUES
(4, '2024-05-04', 'Raisa Diningrat', 'Bayu', 300000, 1239200, 293000, 502100, 304400);
...
--
ALTER TABLE `income_db`
  MODIFY `ic_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
